...
<a href="../../../../downloads/micromouse-debug-kit/04_tof_2/04_tof_2.ino" download="04_tof_2.ino">Download 04_tof_2.ino</a> · <a href="../../../../downloads/micromouse-debug-kit.zip" download>Download the complete kit ZIP</a>

For an individual download, put <code>04_tof_2.ino</code> inside a folder named <code>04_tof_2</code> (Arduino IDE can create it), or paste the complete code into a new sketch. Extract the ZIP first if using the full kit; each sketch already has its matching folder.
