...
<a href="../../../../downloads/micromouse-debug-kit.zip" download>Download the complete debug kit ZIP</a> · [Start step 1](#/docs/Micromouse2026/Debug/01_led_red.md) · [Event wiring map](#/docs/Micromouse2026/Hardware/ESP32C6.md)
...
The downloadable sketches and visualizer are copied unchanged from the event’s <code>micromouse-debug-kit</code>. Wiring and expected results come from their top-of-file comments. [Read the supplied README](../../../../downloads/micromouse-debug-kit/README.md). Each page includes those original comments and the complete sketch, so you can compare the instructions directly with what you upload.
