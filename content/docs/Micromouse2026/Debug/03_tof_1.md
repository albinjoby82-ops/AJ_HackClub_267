...
<a href="../../../../downloads/micromouse-debug-kit/03_tof_1/03_tof_1.ino" download="03_tof_1.ino">Download 03_tof_1.ino</a> · <a href="../../../../downloads/micromouse-debug-kit.zip" download>Download the complete kit ZIP</a>

For an individual download, put <code>03_tof_1.ino</code> inside a folder named <code>03_tof_1</code> (Arduino IDE can create it), or paste the complete code into a new sketch. Extract the ZIP first if using the full kit; each sketch already has its matching folder.
