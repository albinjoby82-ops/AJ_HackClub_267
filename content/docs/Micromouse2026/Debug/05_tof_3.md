---
title: 05 — Add the right distance sensor
layout: default
parent: Debug Kit
nav_order: 5
---

# 05 — Add the right distance sensor

[Debug kit setup and all steps](#/docs/Micromouse2026/Debug/index.md) · [Event pin map](#/docs/Micromouse2026/Hardware/ESP32C6.md)

## Connect

Keep left and front. Add right ToF to the shared power and I²C connections, with its XSHUT → GPIO20.

## Run and check

3/3 sensors OK; L at 0x30, F at 0x31, R at 0x29. The right sensor keeps the default address.
...
<a href="../../../../downloads/micromouse-debug-kit/05_tof_3/05_tof_3.ino" download="05_tof_3.ino">Download 05_tof_3.ino</a> · <a href="../../../../downloads/micromouse-debug-kit.zip" download>Download the complete kit ZIP</a>

For an individual download, put <code>05_tof_3.ino</code> inside a folder named <code>05_tof_3</code> (Arduino IDE can create it), or paste the complete code into a new sketch. Extract the ZIP first if using the full kit; each sketch already has its matching folder.
...
Previous: [04 — Add the front distance sensor](#/docs/Micromouse2026/Debug/04_tof_2.md). Next: [06 — Test all sensors together](#/docs/Micromouse2026/Debug/06_tof_3_imu.md).
