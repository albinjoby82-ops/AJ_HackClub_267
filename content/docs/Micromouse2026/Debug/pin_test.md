...
<a href="../../../../downloads/micromouse-debug-kit/tools/pin_test/pin_test.ino" download="pin_test.ino">Download pin_test.ino</a> · <a href="../../../../downloads/micromouse-debug-kit.zip" download>Download the complete kit ZIP</a>

For an individual download, put <code>pin_test.ino</code> inside a folder named <code>pin_test</code> (Arduino IDE can create it), or paste the complete code into a new sketch. Extract the ZIP first if using the full kit; each sketch already has its matching folder.
