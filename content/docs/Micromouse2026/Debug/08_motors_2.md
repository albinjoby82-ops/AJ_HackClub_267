...
<a href="../../../../downloads/micromouse-debug-kit/08_motors_2/08_motors_2.ino" download="08_motors_2.ino">Download 08_motors_2.ino</a> · <a href="../../../../downloads/micromouse-debug-kit.zip" download>Download the complete kit ZIP</a>

For an individual download, put <code>08_motors_2.ino</code> inside a folder named <code>08_motors_2</code> (Arduino IDE can create it), or paste the complete code into a new sketch. Extract the ZIP first if using the full kit; each sketch already has its matching folder.
