...
<a href="../../../../downloads/micromouse-debug-kit/tools/encoder_test/encoder_test.ino" download="encoder_test.ino">Download encoder_test.ino</a> · <a href="../../../../downloads/micromouse-debug-kit.zip" download>Download the complete kit ZIP</a>

For an individual download, put <code>encoder_test.ino</code> inside a folder named <code>encoder_test</code> (Arduino IDE can create it), or paste the complete code into a new sketch. Extract the ZIP first if using the full kit; each sketch already has its matching folder.
